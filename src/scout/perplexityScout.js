...
function buildMessages() {
  ...
  const systemMessage =
    'You are a real-time news wire service. Your ONLY job is to report what topics are generating the most online conversation RIGHT NOW, as of ' + today + '.\n\n' +
  ...
  const userMessage =
    'Today is ' + today + '. Scan the last 24 hours.\n\n' +
